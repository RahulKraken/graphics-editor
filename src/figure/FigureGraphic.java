...
public abstract class FigureGraphic implements Figure, Serializable
{
	...
	/**
	 * Threshold for terminating a figure in pixels
	 * This corresponds to the visibility threshold of a figure / the approximation of two points.
	 * Below, we consider that it is too small to be valid
	 */
	...
	protected boolean building = false; // The object is being built
