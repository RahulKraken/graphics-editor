...
/**
 * Listen to mouse events on the drawing area
 */
public class CanvasMouseListener implements MouseListener, MouseMotionListener {
	...
	/**
	 * @return figure under construction
	 */
	...
	/**
	 * Function called when the mode has changed
	 * @param mode
	 */
	 ...
	 * and returns the displacement associated with the last recording
	 * @return
	 */
