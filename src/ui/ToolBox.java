...
/**
 * Toolbox that groups the buttons of the different modes of the application as well as the color choices
 */
...
public class ToolBox extends JPanel {
	...
	protected JLabel bgLabel = new JLabel("Fill");
	protected JLabel strokeLabel = new JLabel("outline");
	...
	public ToolBox(Window window, Env env) {
		...
		MouseListener clickBg = new MouseListener() {
			...
			public void mouseClicked(MouseEvent arg0) {
				Color c = JColorChooser.showDialog(w, "Background color", e.getBackgroundColor());
				if(c==null) return;
		...
		MouseListener clickStroke = new MouseListener() {
			...
			public void mouseEntered(MouseEvent arg0) {}
			public void mouseClicked(MouseEvent arg0) {
				Color c = JColorChooser.showDialog(w, "Outline color", e.getStrokeColor());
				if(c==null) return;
				e.setStrokeColor(c);
