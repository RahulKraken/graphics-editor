...
/**
 * Accordion-type panel that displays details on the currently selected figures
 * with the possibility of editing these figures.
 */
...
public class SelectionPanel extends JScrollPane {
	...
	public void onSelectionChanged() {
		...
		JLabel title = new JLabel("Figure(s) selection(s)");
	...
	public class FigureObj extends JPanel {
		...
		public FigureObj(final SelectionPanel parent, final FigureGraphic figure) {
			...
			options.add(new JLabel("Last name: "), constraints);
			++ constraints.gridx;
			...
			JLabel bgLabel = new JLabel("Fill: ");
			...
			JLabel strokeLabel = new JLabel("Outline: ");
			...
			MouseListener clickBg = new MouseListener() {
				...
				public void mouseClicked(MouseEvent arg0) {
					Color c = JColorChooser.showDialog(window, "Background color", figure.getBackgroundColor());
					if(c==null) return;
			...
			MouseListener clickStroke = new MouseListener() {
				...
				public void mouseEntered(MouseEvent arg0) {}
				public void mouseClicked(MouseEvent arg0) {
					Color c = JColorChooser.showDialog(window, "Outline color", figure.getStrokeColor());
					if(c==null) return;
